# Syllabus DSL Specification — v1.1 (Normative)
...
This specification defines **DSL v1.1**.

DSL v1.1 **supersedes v1.0** by making all previously implicit enforcement rules explicit.
...
- This document defines **DSL v1.1**
- Any change to:
...
Syllabi compiled under DSL v1.1 **MUST remain valid forever**.
